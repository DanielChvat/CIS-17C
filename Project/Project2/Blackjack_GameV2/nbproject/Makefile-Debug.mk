...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/blackjack_gamev2.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/blackjack_gamev2.exe: ${OBJECTFILES}
